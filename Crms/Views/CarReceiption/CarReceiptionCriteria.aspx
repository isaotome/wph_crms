...
<%using (Html.BeginForm("Criteria", "CarReceiption", new { id = 0 }, FormMethod.Post)){ %>
<%=Html.Hidden("id", "0") %>
...
<table class="list">
    ...
    <%foreach (var target in Model)
      { %>
    <tr>
        <td style="white-space:nowrap"><a href="javascript:void(0);" onclick="openModalAfterRefresh('/CarReceiption/Entry/' + '<%=target.CustomerCode %>');return false;">受付</a></td>
        <td style="white-space:nowrap"><a href="javascript:void(0);" onclick="openModalAfterRefresh('/CarReceiption/History/' + '<%=target.CustomerCode %>');return false;">履歴</a></td>
