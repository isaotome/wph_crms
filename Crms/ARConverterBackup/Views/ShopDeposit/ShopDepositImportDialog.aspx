...
/*-------------------------------------------------------------------------------------------------*/
/* 作成日：                                                                                        */
/*          2018/05/28 arc yano #3886 Excel取込(ワランティ消込)  新規作成            　　　　　　　*/
/*-------------------------------------------------------------------------------------------------*/        
%>
    <%using (Html.BeginForm("ImportDialog", "ShopDeposit", FormMethod.Post, new { enctype = "multipart/form-data" }))
      { %>
...
<table class="input-form">
    ...
    <tr>
        ...
        <td><%=Html.TextBox("Summary", ViewData["Summary"], new { size ="50", maxlength="50"})%></td>
