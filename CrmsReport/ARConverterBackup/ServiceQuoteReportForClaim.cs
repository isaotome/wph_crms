...
namespace CrmsReport
{
    ...
    /// サービス見積 の概要の説明です。
    /// </summary>
    public partial class ServiceQuoteReportForClaim : GrapeCity.ActiveReports.SectionReport
    {

        public ServiceQuoteReportForClaim()
        {
            //
        ...
        private void ServiceQuoteReport_FetchData(object sender, FetchEventArgs eArgs)
        {
        ...
        private void ServiceQuoteReportForClaim_ReportStart(object sender, EventArgs e)
        {
