...
namespace CrmsReport
{
    ...
    /// サービス見積 の概要の説明です。
    /// </summary>
    public partial class ServiceQuoteReport : GrapeCity.ActiveReports.SectionReport
    {

        public ServiceQuoteReport()
        {
            //
        ...
        private void ServiceQuoteReport_ReportStart(object sender, EventArgs e)
        {
