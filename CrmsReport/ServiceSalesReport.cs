...
namespace CrmsReport
{
    ...
    /// </summary>
    public partial class ServiceSalesReport : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void ServiceSalesReport_FetchData(object sender, FetchEventArgs eArgs)
        {
        ...
        private void ServiceSalesReport_ReportStart(object sender, EventArgs e)
        {
